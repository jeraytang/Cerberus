    ...
    new Vue({
        ...
        mounted: function () {
            ...
            $('#viewModal').on('show.bs.modal', function (event) {
                ...
                http.get(`/api/v1.0/identityResources/${id}`, function (result) {
        ...
        methods: {
            load: function () {
                ...
                http.get(`/api/v1.0/identityResources?${pagedQuery}`, function (result) {
            ...
            submit: function () {
                let that = this;
                http.post(`/api/v1.0/identityResources`, this.newResource, function (result) {
                    if (result.data) {
                        $('#addModal').modal('hide');
                        that.load();
                    } else {
            ...
            disable: function (event) {
                ...
                swal({
                    ...
                    http.put(`/api/v1.0/identityResources/${id}/disable`, {}, function () {
                        that.load();
                    });
                });
            },
            remove: function (event) {
                ...
                swal({
                    ...
                    http.delete(`/api/v1.0/identityResources/${id}`, function (result) {
                        if (result.data) {
                            that.load();
                        } else {
            ...
            enable: function (event) {
                let that = this;
                let id = $(event.currentTarget).parent().parent().attr('id');
                http.put(`/api/v1.0/identityResources/${id}/enable`, {}, function () {
                    that.load();
                });
            },
            update: function () {
                ...
                http.put(`/api/v1.0/identityResources/${id}`, this.originResource, function (result) {
                    if (result.data) {
