...
namespace IdentityServer4.SecurityTokenService.Controllers
{
    ...
    {
        private readonly STSOptions _globalOptions;
        ...
        public AccountController(STSOptions globalOptions, UserManager<IdentityUser> userManager,
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "用户不存在或邮件未激活");
        ...
        public async Task<IActionResult> SendMobilePhoneCode(string phoneNumber)
        {
            ...
            {
                return Json(JsonMessageResult.Fail("手机号码不存在！"));
            }
